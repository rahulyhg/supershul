...
class HT_KB_Exit_Widget extends WP_Widget {
    ...
    */
    public function widget( $args, $instance ) {
        ...
        $exit_widget = '<div class="hkb-exit-shortcode-text">' . $text . '</div>';
        $exit_widget .= '<a class="hkb-exit-shortcode-button button" href="' . apply_filters(HKB_EXITS_URL_FILTER_TAG, $url, 'widget') . '" ' . $new_window . '>' . $btn . '</a>';

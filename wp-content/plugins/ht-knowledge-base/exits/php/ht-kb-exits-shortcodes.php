	...
	class HT_KB_Exits_Shortcodes {	
		...
		*/
		function ht_kb_exit_shortcode( $atts ){
			...
			$exit_shortcode .= '<a class="hkb-exit-shortcode-button button" href="' . apply_filters(HKB_EXITS_URL_FILTER_TAG, $url, 'shortcode') . '" ' . $new_window . '>' . $btn . '</a>';

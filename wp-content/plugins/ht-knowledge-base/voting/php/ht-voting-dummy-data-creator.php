        ...
        */
        function ht_knowledge_base_render_dummy_votes_meta_box() {
            ...
            ?>
                    ...
                    <button id="kb_voting_dummy_create__button" href="<?php echo $add_dummy_data_url; ?>" data-challenge="<?php _e('Add dummy votes?', 'ht-knowledge-base'); ?>"><?php _e('Add Votes'); ?></button>
            <?php
        }

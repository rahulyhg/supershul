    ...
    class HT_Voting_Backend {
        ...
        */
        function adding_article_votes_meta_boxes( $post ) {
            //enqueue style
            wp_enqueue_style( 'data-tables-style', plugins_url( 'css/ht-voting-backend-style.css', dirname( __FILE__ ) ) );
            //enqueue script
            wp_enqueue_script( 'data-tables-script', plugins_url( 'js/jquery.dataTables.js', dirname( __FILE__ ) ), array('jquery'), '1.10.7', true );
            wp_enqueue_script( 'ht-voting-backend', plugins_url( 'js/ht-voting-backend-script.js', dirname( __FILE__ ) ), array('jquery', 'data-tables-script'), '1.0', true );
            //localize

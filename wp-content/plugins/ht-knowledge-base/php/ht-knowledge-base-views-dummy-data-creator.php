...
if (!class_exists('HT_KB_Views_Dummy_Data_Creator')) {
    ...
    class HT_KB_Views_Dummy_Data_Creator {
        ...
        */
        function ht_knowledge_base_render_dummy_views_meta_box() {
            ...
            ?>
                ...
                <button id="ht_kb_views_dummy_create__button" href="<?php echo $add_dummy_data_url; ?>" data-challenge="<?php _e('Add dummy views?', 'ht-knowledge-base'); ?>"><?php _e('Add Views'); ?></button>
            <?php
        }
        ...
        */
        function  add_test_data(){ 
            ...
            if('add'===$action){
                ...
                //create sample views
                $this->create_sample_views($post_id, $count);                
            }
        }
        ...
        * Testing / Debug function
        */
        function create_sample_views($post_id, $number_of_views){
            //create a database controller
            $database_controller = new HKB_View_Count();
            $i = 0;
            ...
            echo '<div class="wrap">';
                echo 'inserted ' . $i . ' sample view records';
            echo '</div>';
        ...
        */
        function enqueue_scripts_and_styles(){
            wp_enqueue_script( 'ht-kb-views-dummy-data', plugins_url( 'js/hkb-views-dummy-data-js.js', dirname( __FILE__ ) ), array(), '1.0', true );
        }

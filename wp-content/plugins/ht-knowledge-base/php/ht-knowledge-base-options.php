    ...
    class Redux_Framework_Knowledge_Base_Settings {
        ...
        */
        public function setSections() {
            ...
            //filter hkb_add_general_settings_section
            $hkb_add_general_settings_section = true;
            $hkb_add_general_settings_section = apply_filters('hkb_add_general_settings_section', $hkb_add_general_settings_section);

            //General Section
            if($hkb_add_general_settings_section){
                $this->sections[] = array(
            ...
            //filter hkb_add_archive_settings_section
            $hkb_add_archive_settings_section = true;
            $hkb_add_archive_settings_section = apply_filters('hkb_add_archive_settings_section', $hkb_add_archive_settings_section);

            //Archive Section
            if($hkb_add_archive_settings_section){
                $this->sections[] = array(
            ...
            //filter hkb_add_article_settings_section
            $hkb_add_article_settings_section = true;
            $hkb_add_article_settings_section = apply_filters('hkb_add_article_settings_section', $hkb_add_article_settings_section);

            //Article Section
            if($hkb_add_article_settings_section){
                $this->sections[] = array(
            ...
            //filter hkb_add_live_search_settings_section
            $hkb_add_live_search_settings_section = true;
            $hkb_add_live_search_settings_section = apply_filters('hkb_add_live_search_settings_section', $hkb_add_live_search_settings_section);

            //Live Search Section
            if($hkb_add_live_search_settings_section){
                $this->sections[] = array(
            ...
            //filter hkb_add_archive_settings_section
            $hkb_add_slugs_settings_section = true;
            $hkb_add_slugs_settings_section = apply_filters('hkb_add_slugs_settings_section', $hkb_add_slugs_settings_section);

            //Slugs Section
            if($hkb_add_slugs_settings_section){
                $this->sections[] =  array( 
            ...
            //filter hkb_add_custom_styles_settings_section
            $hkb_add_custom_styles_settings_section = true;
            $hkb_add_custom_styles_settings_section = apply_filters('hkb_add_custom_styles_settings_section', $hkb_add_custom_styles_settings_section);

            //Custom Styles Section
            if($hkb_add_custom_styles_settings_section){
                $this->sections[] =  array( 
                    'title'     => __('Custom Styles', 'ht-knowledge-base'),
...
if(!function_exists('ht_kb_get_post_types')){
    ...
    */
    function ht_kb_get_post_types($args=null) {
        ...
        return apply_filters('ht_kb_get_post_types', $data);
    }    
}

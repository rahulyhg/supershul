        ...
        */
        function ht_kb_welcome_screen(){
            ...
            <div class="wrap about-wrap">
                ...
                <h1><?php _e('Welcome to Heroic Knowledge Base');  ?></h1>
                ...
                <div class="feature-section col two-col">
                    <div>
                        ...
                        <ol>
                            ...
                            <?php printf(__('Your Knowledge Base is now available from <a href="%s" target="_blank">The Knowledge Base Archive</a>, %s.', 'ht-knowledge-base') , 
                                get_post_type_archive_link( 'ht_kb'),
                                $ht_kb_state_text
                                ); ?>
                            </li>
                            <li>
                            ...
                            <?php printf(__('You can control most options for the Knowledge Base from the <a href="%s" target="_blank">Knowledge Base Settings</a> page', 'ht-knowledge-base') , 
                                admin_url('edit.php?post_type=ht_kb&page=_ht_kb_options')
                                ); ?>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <p><?php printf(__('Visit <a href="%s" target="_blank">HeroThemes</a>, or signup with the form below for more tips, guides and addons to harness the power of your new Knowledge Base', 'ht-knowledge-base') , 'http://herothemes.com'); ?></p>
                        <!-- Sign up form -->
                    ...
                    <div class="last-feature">
                        ...
                        <?php else: ?>
                            <p><?php printf(__('<b>Important:</b> To enable automatic updates and support for this site, be sure to enter your license key on the <a href="%s" target="_blank">license and updates tab</a> of your Knowledge Base settings, this ensures you have the latest and supported version of the plugin.', 'ht-knowledge-base'), admin_url('edit.php?post_type=ht_kb&page=_ht_kb_options&tab=7')); ?></p>
                        <?php endif; ?>
...
if (class_exists('HT_Knowledge_Base_Welcome')) {
    $ht_knowledge_base_welcome_init = new HT_Knowledge_Base_Welcome();
}
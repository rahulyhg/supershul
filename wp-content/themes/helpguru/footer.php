...
<div class="ht-container">
  ...
  <small id="copyright" role="contentinfo"><?php echo get_theme_mod( 'ht_copyright', __( '&copy; Copyright HelpGuru. Powered by <a href="http://herothemes.com">HeroThemes</a>.', 'ht-theme' ) ); ?></small>
  <?php } ?>

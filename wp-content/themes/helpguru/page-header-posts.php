...
<?php if (get_theme_mod( 'ht_blog_tagline' )) : ?><h2 id="page-header-tagline">echo get_theme_mod( 'ht_blog_tagline', __( 'Important news from the super support team.', 'ht-theme' ) );</h2><?php endif; ?>

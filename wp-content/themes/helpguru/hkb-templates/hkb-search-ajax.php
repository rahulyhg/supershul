  ...
  <?php $total_results = 0; ?>
    ...
    <?php if($total_results>0): ?>
      <li class="hkb-searchresults__showall">
        <a href="<?php echo site_url( '?s=' . $s . '&ht-kb-search=1' ); ?>" title="<?php _e('Show all results', 'ht-theme'); ?>"><?php _e('Show all results', 'ht-theme'); ?></a> 
      </li>
    <?php else: ?>
      <li class="hkb-searchresults__noresults">
        <span><?php _e('No Results', 'ht-theme'); ?></span>
      </li>
    <?php endif; ?>

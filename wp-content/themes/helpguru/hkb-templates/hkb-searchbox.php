...
<?php if(hkb_show_knowledgebase_search()): ?>
    ...
    <form class="hkb-site-search" method="get" action="<?php echo home_url( '/' ); ?>">
        <label class="hkb-screen-reader-text" for="s"><?php _e( 'Search For', 'ht-theme' ); ?></label>
        ...
        <button class="hkb-site-search__button" type="submit"><span><?php _e( 'Search', 'ht-theme' ); ?></span></button>
    </form>
<?php endif; ?>
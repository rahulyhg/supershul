...
<div id="hkb" class="hkb-template-single">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<?php } // End if has_post_format(video) ?>
			...
			</h1><h2><?php the_field('subtitle'); ?></h2>

			<ul class="hkb-entry-meta clearfix">

				<li class="hkb-em-date"> 
				    <span><?php _e( 'Created' , 'ht-theme' ) ?></span>
				...
				<li class="ht-kb-em-author">
					<span><?php _e( 'Author' , 'ht-theme' ) ?></span>
				...
				<?php if( !is_tax() ) : ?>
					<li class="ht-kb-em-category">
					    <span><?php _e( 'Category' , 'ht-theme' ) ?></span>
					    <?php 
						    $terms = get_the_term_list( $post->ID, 'ht_kb_category', ' ', ', ', '' );
						    if(empty($terms)){
						    	_e('Uncategorized', 'ht-theme');
						    } else {
						    	echo $terms;
						    }
					    ?>
				...
				<?php if ( comments_open() && get_comments_number() > 0 ){ ?>
					<li class="ht-kb-em-comments">
					    <span><?php _e( 'Comments' , 'ht-theme' ) ?></span>
						<?php comments_popup_link( __( '0', 'ht-theme' ), __( '1', 'ht-theme' ), __( '%', 'ht-theme' ) ); ?>
					</li>
				<?php } ?>
